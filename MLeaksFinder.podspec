...
#                       DESC
  ...
  s.homepage         = "https://github.com/wumeijun/iOSMLeaksFinder"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "wumeijun" => "1852151879@163.com" }
  s.source           = { :git => "https://github.com/wumeijun/iOSMLeaksFinder.git", :tag => s.version }
